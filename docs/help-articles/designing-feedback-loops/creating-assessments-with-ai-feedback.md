...
<https://practera.com/wp-content/uploads/2024/02/How-to-Create-an-assessment-with-AI-Feedback.mp4>
  ...
  * Add an [assessment by dragging ‘Feedback’](./preparing-feedback-loops/#1-toc-title) from Activity tasks.
...
![Image](assets/images/designing-feedback-loops/creating-assessments-with-ai-feedback/Screenshot-2024-02-08-at-8.44.59-pm-1.png)

  * Click ‘+ New Group’ and edit the Name and Group Description (as needed)

![Image](assets/images/designing-feedback-loops/creating-assessments-with-ai-feedback/Screenshot-2024-02-08-at-8.45.33-pm-300x272.png)

  * Click ‘+ New Question’, edit the Question, add Additional Details (as needed) and set the Question Type to ‘Text’

![Image](assets/images/designing-feedback-loops/creating-assessments-with-ai-feedback/Screenshot-2024-02-08-at-8.45.47-pm-300x251.png)

*All other settings can be modified as required
  * Add your AI prompt and Exemplar respectively. Make sure to consider this [AI Framework](./practera-ai-feedback-prompt-framework/)

![Image](assets/images/designing-feedback-loops/creating-assessments-with-ai-feedback/Screenshot-2024-02-08-at-8.48.49-pm-300x186.png)
...
![Image](assets/images/designing-feedback-loops/creating-assessments-with-ai-feedback/Screenshot-2024-02-08-at-8.51.17-pm.png)

  * Add a ‘Test Suite’ by putting a name for the assessment (ex: CM #1) and click ‘Save’

![Image](assets/images/designing-feedback-loops/creating-assessments-with-ai-feedback/Screenshot-2024-02-08-at-8.51.22-pm.png)

  * Add your Test answer for the question and click ‘Test’. Wait for the AI Response.

![Image](assets/images/designing-feedback-loops/creating-assessments-with-ai-feedback/Screenshot-2024-02-08-at-8.51.37-pm.png)
